...
<div class="card mb-4">
			...
			<div class="modal-content">
				<form method="POST" action="../../../control/stock/Update.php">
					...
					<div class="form-group">
						<label></label>
						<input  type="hidden" value="<?php echo $result['id'];?>" name="id" id="id" class="form-control" readonly required>
					</div>
					<div class="form-group">
						<label></label>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" action="../../../control/stock/Edit.php">
					...
					<div class="form-group">
						<label>จำนวนที่นำเข้า</label>
						<input type="number" value="<?php echo $result['amount'];?>" name="amount" id="amount" class="form-control" onchange="" min="0" maxlength="7" required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูล')">
					</div>
					<div class="form-group">
						<label>ราคาต่อหน่วย</label>
						<input type="number" value="<?php echo $result['price'];?>" name="price" id="price" class="form-control" onchange="" min="0" maxlength="7" required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูล')">
					</div>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="ยกเลิก">
	...
	<!--End Edit Modal -->
	<!-- Delete Modal HTML -->
	<div id="deleteModal<?php echo $result['id']; ?>" name="delete" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST">
					<div class="modal-header">
					...
					<div class="modal-body">
						<p>รหัส : <?php echo $result['id']; ?></p>
                        <p>ชื่อ  : <?php echo $result['name'];?></p>
                        <p>จำนวน : <?php echo $result['amount']; ?></p>
						<p>ราคา : <?php echo $result['price']; ?></p>
					</div>
					<div class="modal-footer">
